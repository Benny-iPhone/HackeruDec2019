...
class MainViewController: UIViewController {
    ...
    private func loadData(with filter : String?) {
        FirebaseManager.manager.getAllChatrooms(filter: filter) { [weak self](chatrooms) in
